            ...
            <div class="ai-agent-sheet">
                ...
                <section class="ai-agent-section">
                    <p class="ai-agent-note">
                        مدل هوش مصنوعی، شخصیت دستیار، سوال‌های پیشنهادی، ربات بله، دانش دستی
                        و پرسش‌وپاسخ، و پشتیبانی همه از پنل دانیچَت کنترل می‌شن — این‌جا فقط
                        توکن و ظاهر ویجت رو تنظیم می‌کنی. برای بقیه‌ی تنظیمات به
                        <a href="https://dunichat.ir/dashboard" target="_blank" rel="noopener">پنل دانیچَت</a>
                        برو.
                    </p>
                </section>
