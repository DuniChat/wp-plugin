...
تماس‌های تازه‌ی افزونه با API دانی‌چت:
    • ربات‌های پیام‌رسان (تلگرام و بله)
...
نام کاربری ربات را نمی‌فرستیم: سرور خودش با getMe از تلگرام یا بله
می‌پرسد. همان چیزی که به بازدیدکننده گفته می‌شود باید همانی باشد که
