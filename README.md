...
### 🤖 ربات تلگرام و بله
- اتصال ربات با توکن BotFather (هم تلگرام، هم بله)
- همان دستیار سایت، با همان اطلاعات و همان مدل، داخل پیام‌رسان
- پشتیبانی از **متن، عکس و پیام صوتی** (ویس به متن تبدیل می‌شود)
- منو و دکمه‌های شیشه‌ای؛ لینک محصولات زیر پاسخ می‌آید
- انتقال گفت‌وگوی سایت به پیام‌رسان با یک کد شش‌رقمی
