...
- تم **هماهنگ با سایت** (یا قفل روی روشن/تاریک) از تنظیمات افزونه
...
- زمان‌بندی خودکار (روزانه / هر سه روز / هفتگی)
...
│   │   └── settings.js        # منطق پنل تنظیمات (مدل‌ها، سینک، رنگ‌ها، گفت‌وگوها)
│   ├── css/
│   │   ├── ai-agent.css          # استایل ویجت چت
│   │   └── dunichat-admin.css    # دیزاین‌سیستم پنل پیشخوان
│   └── fonts/
│       └── Vazirmatn.ttf      # فونت variable، همراه افزونه (بدون CDN)
│
└── README.md
```
